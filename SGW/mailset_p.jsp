...
<h2>メールチェックのための設定</h2>　　　　利用者：<span id="userN"></span>　<button class='hozon' id="hozon">保存</button><br><br>
※ここで、設定したメールアカウントに　メールが届いていた場合　トップページでお知らせします。ただし、メールの中身は、メールソフトでないと閲覧できません。
<br>※「メールアカウント名」、「パスワード」、「POP3サーバ名」のいずれかが、空欄であれば、メールチェックは行いません。<br><br>
